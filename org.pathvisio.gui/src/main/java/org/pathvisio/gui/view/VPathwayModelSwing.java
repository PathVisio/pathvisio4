 ...
 */
public class VPathwayModelSwing extends JPanel implements VPathwayWrapper, MouseMotionListener, MouseListener,
	...
	public void showToolTip(final VPathwayModelEvent e) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				if (elements.size() > 0) {
					PathwayModelToolTip tip = new PathwayModelToolTip(elements);
	...
	class PathwayModelToolTip extends JPanel {
		private boolean hasContent;

		public PathwayModelToolTip(List<VElement> elements) {
