...
/**
 * An implementation of the SimilarityFunction that compares elements, that was
 * written after BasicSim and should be more finely tuned
 */
public class BetterSim extends SimilarityFunction {

	/**
	 * returns a score between 0 and 100, 100 if both elements are completely
	 * similar
	 */
	public int getSimScore(PathwayElement oldE, PathwayElement newE) {
		...
		if (possibleScore == 0)
			return 0; // div by zero prevention
