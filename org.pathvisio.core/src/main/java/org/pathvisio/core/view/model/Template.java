...
/**
 * Represents a template that consists of graphics and can be added to a
 * pathway.
 * 
 * @author thomas
 */
public interface Template {
	 ...
	 * Coordinates mx and my represent the point where the template has to be
	 * inserted (in model coordinates)
	 * 
	...
	/**
	 * Get the element that will be used to drag the template after adding (e.g. the
	 * South-East handle in case of a DataNode)
	 * 
