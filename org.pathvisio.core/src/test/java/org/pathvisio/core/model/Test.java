...
public class Test extends TestCase implements PathwayListener, PathwayElementListener {
	...
	public void testXRefEquals() {
		Object[] testList = new Object[] { new Xref("1007_at", BioDataSource.AFFY),
				new Xref("3456", BioDataSource.AFFY), new Xref("1007_at", BioDataSource.ENTREZ_GENE),
				new Xref("3456", BioDataSource.ENTREZ_GENE), new Xref("3456", BioDataSource.ENTREZ_GENE),
